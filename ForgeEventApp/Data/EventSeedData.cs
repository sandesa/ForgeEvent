            ...
            if (!context.Events.Any())
            {
                ...
                var events = new List<Event>
                {
                    new()
                    {
                        ...
                        CreatedAt = new DateOnly(2024,05,01),
                    ...
                    new()
                    {
                        ...
                        Date = new DateOnly(2024,07,20),
                        CreatedAt = new DateOnly(2024,05,02),
                    ...
                    new() 
                    {
                        ...
                        Date = new DateOnly(2024,08,10),
                        CreatedAt = new DateOnly(2024, 05, 03),
                    ...
                    new()
                    {
                        ...
                        Date = new DateOnly(2024, 09, 05),
                        CreatedAt = new DateOnly(2024, 05, 04),
                    ...
                    new()
                    {
                        ...
                        CreatedAt = new DateOnly(2024, 05, 05),
                    ...
                    new() 
                    {
                        ...
                        CreatedAt = new DateOnly(2024, 05, 06),
                    ...
                    new()
                    {
                        ...
                        CreatedAt = new DateOnly(2024, 05, 07),
                    ...
                    new()
                    {
                        ...
                        CreatedAt = new DateOnly(2024, 05, 08),
                    ...
                    new()
                    {
                        ...
                        CreatedAt = new DateOnly(2024, 05, 09),
                    ...
                    new() 
                    {
						...
						Date = new DateOnly(2025, 03, 10),
                        CreatedAt = new DateOnly(2024, 05, 10),
